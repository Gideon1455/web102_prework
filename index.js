...
contributionsCard.innerHTML = `<p>${totalContributors.toLocaleString('en-US')}</p>`;
...
let unfundedGames = filterUnfundedOnly()
let totalUnfundedGames  = unfundedGames.reduce( (acc) => {return acc + 1;}, 0 );


// create a string that explains the number of unfunded games using the ternary operator
const displayStr = 
 `<p>
 A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${(totalGames - totalUnfundedGames).toLocaleString('en-US')}. There are currently ${totalUnfundedGames > 0 ? totalUnfundedGames : "no"} 
 unfunded games.
 </p>
 `
